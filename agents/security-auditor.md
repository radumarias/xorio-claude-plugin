...
description: |
  ...
  <example>Context: User wants a security review. user: "Audit the auth module for security issues"</example>
  <example>Context: User is concerned about vulnerabilities. user: "Check my API endpoints for injection flaws"</example>
color: red
model: opus
tools:
  - Glob
